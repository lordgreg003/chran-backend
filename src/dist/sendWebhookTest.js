...
var webhookUrl = "https://hook.eu2.make.com/1iq799yjpugo0v7fgwwfggvj21qyrren";
// Send the request using Axios
var sendTestRequest = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1["default"].post(webhookUrl, payload, {
                        headers: {
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Error sending test request:", error_1.message);
                if (error_1.response) {
